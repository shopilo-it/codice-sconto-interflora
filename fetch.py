#!/usr/bin/env python3
"""
Recupero codici sconto Interflora da shopilo.it
Sursa: https://shopilo.it/negozi/interflora.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/interflora.it"
STORE_NAME = "Interflora"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Interflora da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-interflora)"
    }
    try:
